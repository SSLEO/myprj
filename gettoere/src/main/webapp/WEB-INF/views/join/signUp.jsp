				...
				if(result=='0'){
					if(userID.length>4){
						...
						$('#idcheckMessage').css("color","blue");
	 					...
	 					$('#idcheckMessage').html("사용할수 없는 아이디입니다.");
				...
				<form role="form" method="post" name="userInfo" onsubmit="return checkValue()">
					<div class="box-body">
						<div class="page-header">
							...
							<h1>&nbsp회원가입 <small>gettoere</small></h1>
						</div>
						<div class="col-md-6 col-md-offset-3">
							<div class="form-group">
								<label for="InputId">아이디</label>
								<input type="text" class="form-control" name="id" id="id" maxlength="15" placeholder="5~15자, 영어+숫자 가능">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nickname" id="nickname" maxlength="15" placeholder="닉네임을 입력">
								<p class="help-block" id="nicknamecheckMessage"></p>
							</div>
							<div class="form-group">
								<label for="InputName">이름</label>
								<input type="text" class="form-control" id="name" name="name" maxlength="15" placeholder="이름을 입력">
							</div>
							<label for="InputPhone">휴대폰</label>
							<div class="form-group">
								<input type="tel" class="form-control" id="phone" name="phone" maxlength="11" placeholder="'-'을 제외해서 입력">
								<p class="help-block" id="phonecheckMessage"></p>
							</div>
							<div class="form-group">
								<label for="InputEmail">이메일</label>
								<input type="text" class="form-control" id="email" name="email" maxlength="30" placeholder="이메일을 입력">
					...
					<div class="box-footer">
						<div class="form-group text-center">
							...
							<button type="button" class="btn btn-warning" onclick="goFirstForm()">
